...
const GALLERY_IMAGES = Array.from({ length: 20 }, (_, i) => ({
  id: i + 1,
  url: `/images/gallery/story-${i + 1}.jpg`,
  placeholder: `https://images.unsplash.com/photo-${[
    '1547514701-42782101795e', '1523363342553-61fc072a2455', '1510626176961-4b57d4fbad03', '1550989460-0adf9ea622e2',
    '1550506389-d10667ea894a', '1588107908922-8179269e8841', '1556761175-5973cf0f32e7', '1523362628242-4dc5820061fa',
    '1589733902251-6f6368d18440', '1591073113125-e46713c829ed', '1513558161293-cdaf765ed2fd', '1544026760-49896ce1231f',
    '1595981267035-7b04ca84a82d', '1559181567-c3190ca9959b', '1551024709-8f23befc6f87', '1444927714506-8492d94b4e3d',
    '1556679343-c7306c1976bc', '1589733901241-5e5d070b427b', '1510626176961-4b57d4fbad03', '1596701062351-8c0c1692267b'
  ][i]}?q=80&w=800`,
  alt: `Just It Story ${i + 1}`,
  caption: [
    "Natural Energy", "Zesty Life", "Wild Berries", "Spicy Vibes", "Tropical Escape",
    "Cooling Mind", "Floral Heart", "Superfood", "Coastal Soul", "Velvet Sun",
    "Modern Living", "Heritage", "Aromatic", "Focus", "Extra Bold",
    "Golden Hour", "No Crash", "Pure Life", "Grown Here", "Real Goodness"
  ][i]
}));
...
const GalleryItem: React.FC<GalleryItemProps> = ({ image, index }) => {
  ...
  const handleError = () => {
    if (imgRef.current) {
      imgRef.current.src = image.placeholder;
    }
  };
